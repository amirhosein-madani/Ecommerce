...
class ProfileImageEditView(LoginRequiredMixin, HasAdminAccessPermission, View):
    ...
    def post(self, request, *args, **kwargs):
        ...
        return redirect("dashboard:admin:profile_edit")


class ProfileImageDeleteView(LoginRequiredMixin, HasAdminAccessPermission, View):
